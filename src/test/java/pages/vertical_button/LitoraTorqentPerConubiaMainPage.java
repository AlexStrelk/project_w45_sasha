...
public class LitoraTorqentPerConubiaMainPage {
    SelenideElement buttonLitoraTorqentPerConubia =
            $(byXpath("//*[@id='recent-posts-2']//a[text()='Litora torqent per conubia']"));
    String controlText = "//h2";


    @Step
    public void pressButtomLitoraTorqentPerConubia() {
        buttonLitoraTorqentPerConubia.click();
        logger.info("OK");
    }
